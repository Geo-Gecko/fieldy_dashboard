...
import { getcreateputGraphData } from '../../actions/layerActions';
import {
...
describe("graphAction", () => {
  ...
  it('should get an indicator', async () => {
    response_data = {
    ...
    mock.onGet(`/layers/fieldindicators/`).reply(200, response_data);
  ...
  //   mock.onGet(`layers/fieldindicators/`).reply(403, {});
  //   store.dispatch(getPolygonLayers())
  //     .catch(() => {
  //       expect(store.getActions()).toEqual([{
